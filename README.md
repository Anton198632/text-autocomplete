...
Перед тем как использовать сеть необходимо её обучить. Скачайте датасет с короткими постами https://code.s3.yandex.net/deep-learning/tweets.txt и расположите в каталоге `./data/`. Следующие шаги см. в ноутбуке `./solution.ipynb`
